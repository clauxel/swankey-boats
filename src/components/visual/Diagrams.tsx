export function DeckPlan({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 520 220" className={className} role="img" aria-label="E498 deck layout diagram">
      <rect x="16" y="36" width="488" height="148" rx="74" fill="#0b1620" stroke="#1f3a46" />
      ...
      <circle cx="260" cy="128" r="10" fill="#328ed4" />
      <rect x="168" y="96" width="46" height="28" rx="4" fill="#246994" opacity="0.55" />
      <text x="152" y="28" fill="#9bd8ff" fontSize="11" fontFamily="ui-monospace, monospace">
        BOW CASTING DECK
      </text>
...
export function JetCutaway({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 560 220" className={className} role="img" aria-label="Protected electric jet intake diagram">
      <rect width="560" height="220" fill="#0b1620" rx="16" />
      <path d="M40 70h360c40 0 80 18 120 46v20H40z" fill="#1e293b" />
      <path d="M40 136h480v24H40z" fill="#246994" opacity="0.35" />
      <rect x="168" y="108" width="120" height="36" rx="8" fill="#6cbcf2" opacity="0.85" />
      <path d="M288 116h90c18 4 40 14 70 28v12H288z" fill="#9bd8ff" opacity="0.7" />
      <path d="M176 150c18 16 54 26 92 26s74-10 92-26" fill="none" stroke="#6cbcf2" strokeWidth="2" />
      <text x="40" y="36" fill="#9bd8ff" fontSize="12" fontFamily="ui-monospace, monospace">
...
export function StationKeepingDiagram({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 560 220" className={className} role="img" aria-label="GNSS station keeping diagram">
      <rect width="560" height="220" fill="#0b1620" rx="16" />
      <circle cx="280" cy="118" r="78" fill="none" stroke="#6cbcf2" strokeDasharray="4 6" />
      <circle cx="280" cy="118" r="46" fill="none" stroke="#328ed4" opacity="0.7" />
      <rect x="250" y="102" width="60" height="24" rx="8" fill="#94a3b8" />
      <path d="M40 40h80" stroke="#9bd8ff" markerEnd="url(#arrow)" />
      <defs>
        <marker id="arrow" markerWidth="8" markerHeight="8" refX="6" refY="4" orient="auto">
          <path d="M0 0 L8 4 L0 8z" fill="#9bd8ff" />
        </marker>
      </defs>
      <path d="M480 70v60" stroke="#328ed4" markerEnd="url(#arrow)" />
      ...
      <text x="150" y="206" fill="#9bd8ff" fontSize="12" fontFamily="ui-monospace, monospace">
