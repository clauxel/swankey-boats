export function DeckPlan({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 520 220" className={className} role="img" aria-label="HQ E498 deck layout diagram">
      ...
      <circle cx="260" cy="128" r="10" fill="#14b8a6" />
      <rect x="168" y="96" width="46" height="28" rx="4" fill="#0f766e" opacity="0.55" />
      <text x="152" y="28" fill="#67e8f9" fontSize="11" fontFamily="ui-monospace, monospace">
        BOW CASTING DECK
      </text>
...
export function JetCutaway({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 560 220" className={className} role="img" aria-label="Protected electric jet intake diagram">
      ...
      <path d="M40 136h480v24H40z" fill="#0f766e" opacity="0.35" />
      ...
      <text x="40" y="36" fill="#67e8f9" fontSize="12" fontFamily="ui-monospace, monospace">
...
export function StationKeepingDiagram({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 560 220" className={className} role="img" aria-label="GNSS station keeping diagram">
      ...
      <circle cx="280" cy="118" r="46" fill="none" stroke="#14b8a6" opacity="0.7" />
      ...
      <path d="M480 70v60" stroke="#14b8a6" markerEnd="url(#arrow)" />
      ...
      <text x="150" y="206" fill="#67e8f9" fontSize="12" fontFamily="ui-monospace, monospace">
